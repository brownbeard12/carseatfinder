...
// ------- Util: update status for zero price ----------
exports.updateStatusForZeroPrice = functions.https.onRequest((request, response) => {
  ...
  //Call query
  utils.updateStatusForZeroPrice(client, q).then(() => response.send("Complete!"));
